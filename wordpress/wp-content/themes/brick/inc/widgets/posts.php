        	...
        	<?php
				...
				foreach($posts as $p) {?>
                    <li>
						...
						<?php } else $class='';?>
                        <?php if ( $instance['display_title'] ) { ?><div class="widget-title"><a href="<?php echo get_permalink($p->ID); ?>" rel="bookmark"  title="<?php echo $p->post_title; ?>"><?php echo $p->post_title?></a></div><?php } ?>
